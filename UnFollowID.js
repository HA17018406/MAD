...
export default class UnFollowID extends Component {
    constructor(props) {
        super(props);
        this.state = {
            token: '',
    ...
    render() {
        return (
            <View>
                <Text style={{ color: '#4094f0', textAlign: 'center', fontSize: 25 }}>Unfollow a user</Text>
                <Text></Text>
                <Text> </Text>
                ...
                <Text> </Text>
                <Text> </Text>
                <Button title="Click to UnFollow" onPress={this.followID} />
            </View>
        )
    }
}
